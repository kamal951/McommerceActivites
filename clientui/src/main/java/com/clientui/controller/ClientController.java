...
import com.clientui.proxies.MicroserviceExpeditonProxy;
...
public class ClientController {
    ...
    @Autowired
    private MicroserviceExpeditonProxy expeditonProxy;
